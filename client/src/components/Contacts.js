    ...
    <ListGroup variant="flush">
      {contacts.length === 0 ? (
        <div className="p-4 text-center text-muted animate-fade-in-scale">
          ...
          <p className="mb-1" style={{ fontSize: '1.05rem', color: '#41525d' }}>No contacts yet</p>
          <p className="small">Click <strong style={{ color: 'var(--primary-dark)' }}>+ New Contact</strong> below to add someone using their ID.</p>
        </div>
      ) : (
