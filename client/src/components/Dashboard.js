...
export default function Dashboard({ id }) {
  ...
  return (
    <div className="d-flex" style={{ height: '100vh', backgroundColor: '#efeae2', backgroundImage: 'url("https://web.whatsapp.com/img/bg-chat-tile-light_04fcacde539c58cca6745483d4858c52.png")', backgroundRepeat: 'repeat', backgroundSize: '400px', opacity: 0.98 }}>
      <Sidebar id={id} />
      {selectedConversation ? <OpenConversation /> :
        <div className="flex-grow-1 d-flex flex-column align-items-center justify-content-center text-center p-5" style={{ zIndex: 1 }}>
          <div style={{ width: '120px', height: '120px', borderRadius: '50%', backgroundColor: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '2rem', boxShadow: '0 8px 24px rgba(0,0,0,0.05)' }} className="animate-fade-in-scale">
